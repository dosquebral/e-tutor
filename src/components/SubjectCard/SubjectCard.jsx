  ...
  return (
    ...
    <div className='container py-14 md:py-24'>
        <div className='space-y-4 p-6 text-center max-w-[600px] mx-auto mb-5'>
            <p className='uppercase text-orange-500 font-semibold'>Our tutor subjects</p>
            <h1 className='font-semibold text-3xl'>Find Online Tutor in Any Subject</h1>
        </div>
                ...
                subjectList.map((subject) => {
                    return (
                        ...
                        className='border rounded-lg border-secondary/20 p-4 flex justify-start items-center gap-4 hover:!scale-105 hover:!shadow-xl duration-200 cursor-pointer'>
                            <div style={{backgroundColor: subject.color + '30', color: subject.color}}
